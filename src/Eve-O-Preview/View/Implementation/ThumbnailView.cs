...
namespace EveOPreview.View
{
    public abstract partial class ThumbnailView : Form, IThumbnailView
    {
        ...
        private bool _lockSizeAndPosThumbnail;
        ...
        protected ThumbnailView(IWindowManager windowManager)
        {
            ...
            this._opacity = 0.1;
            this._lockSizeAndPosThumbnail = false;
        ...
        public void setLockSizeAndPosThumbnail(bool enable)
        {
            this._lockSizeAndPosThumbnail = enable;
            this._overlay.SetLockSizeAndPosThumbnail(Text, _lockSizeAndPosThumbnail);
        }
        ...
        {
            if (this._lockSizeAndPosThumbnail)
            {
                return;
            }
